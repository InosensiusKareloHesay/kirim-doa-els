...
export default function DashboardPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#e9f0f7', display: 'flex', flexDirection: 'column' }}>
      <Navbar title="Admin Home" onLogout={() => router.push('/kirim-doa-els/')} />
      ...
      <div className="dashboard-btn-group" style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'flex-start', padding: '40px 0', gap: 24, flexDirection: 'row' }}>
        <button className="dashboard-btn" onClick={() => router.push('/kirim-doa-els/doa/')} style={{ flex: 1, minWidth: 180, maxWidth: 320, padding: '14px 0', borderRadius: 32, background: '#1a357a', color: '#fff', fontWeight: 600, fontSize: 20, border: 'none', cursor: 'pointer', transition: 'background 0.2s' }}>Lihat List Doa</button>
